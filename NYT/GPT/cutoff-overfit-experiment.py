...
cutoff_end_chars = int(sys.argv[1]) if len(sys.argv) >= 2 else None  # None for full articles
...
tokenized_train_path = f'tokenized/train_{size_str}_{ending}.pt'
tokenized_test_path = f'tokenized/test_{size_str}_{ending}.pt'

vectorized_train_path = f'vectorized/train_{size_str}_{ending}.pt'
vectorized_test_path = f'vectorized/test_{size_str}_{ending}.pt'


print('tokenized_train_path:  ', tokenized_train_path)
print('tokenized_test_path:   ', tokenized_test_path)
print('vectorized_train_path: ', vectorized_train_path)
print('vectorized_test_path:  ', vectorized_test_path)

print_f(f'Cutoff: {cutoff_end_chars} | Chunk size: {chunk_size} | Train limit: {train_size} | Test limit: {test_size} | Seed: {seed}')
